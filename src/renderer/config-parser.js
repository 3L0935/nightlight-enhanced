...
const FIELD_DEFS = {
  ...
  gameplay: {
    ...
    fields: [
      ...
      { key: 'SurvivorMouseSensitivity', label: 'Survivor Mouse Sens', min: 5, max: 100, step: 1, unit: '%', impact: 'none', desc: 'Mouse sensitivity for survivor. 5 = minimum, 100 = max.' },
      { key: 'KillerMouseSensitivity', label: 'Killer Mouse Sens', min: 5, max: 100, step: 1, unit: '%', impact: 'none', desc: 'Mouse sensitivity for killer. 5 = minimum, 100 = max.' },
